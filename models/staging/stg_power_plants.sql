...
cleaned as (
    ...
    select
        ...
        cast(estimated_generation_gwh_2013 as double) as estimated_generation_gwh_2013,
        cast(estimated_generation_gwh_2014 as double) as estimated_generation_gwh_2014,
        ...
        cast(estimated_generation_gwh_2016 as double) as estimated_generation_gwh_2018,
        cast(estimated_generation_gwh_2017 as double) as estimated_generation_gwh_2019,
